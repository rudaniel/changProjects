...
public class Student {
	 ...
	 */
	public Student(Profile profile, double payment, Date date) {
	 ...
	 * @param payment payment by student.
	 */
	public Student(Profile profile, double payment) {
		this.profile = profile;
		this.payment=payment;
	}
	 ...
	 * @param studyAbroad studyAbroad status.
	 * @return true if studyAbroad changed, false otherwise.
	 */
